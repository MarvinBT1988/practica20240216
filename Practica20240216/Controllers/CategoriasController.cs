...
namespace Practica20240216.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(Practica20240216DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categorias != null ? 
                          ...
                          Problem("Entity set 'Practica20240216DBContext.Categorias'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Practica20240216DBContext.Categorias'  is null.");
            }
            var categoria = await _context.Categorias.FindAsync(id);
            if (categoria != null)
            {
